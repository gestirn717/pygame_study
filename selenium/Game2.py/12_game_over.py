...
def display_score():
    txt_curr_score = game_font.render(f"Curr Score : {curr_score:,}", True, BLACK) #세자리마다 , 넣기
...
while running:
    ...
    display_time(total_time - int(elapsed_time)) #시간 보여주기
...
pygame.time.delay(3000)    #2초 정도 대기 후 종료
pygame.quit()
