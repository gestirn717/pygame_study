...
def merge_image():
    ...
    #max로 감싸주면 리스트중 최댓값, sum으로 감싸주면 리스트값 다 합쳐줌 
    #최대 너비, 전체 높이 구해줌
    max_width, total_height = max(widths), sum(heights)
     
    
    #스케치북 준비
    #새로운 이미지를 만들고 값은 RGB, 크기는 최대너비와 전체 높이, 배경은 흰색으로 
    ...
    #경로 저장 
    dest_path = os.path.join(txt_dest_path.get(),"mergi_photo.jpg")
